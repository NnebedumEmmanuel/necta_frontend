              ...
              <div className="bg-white border border-gray-200 rounded-lg overflow-hidden hover:shadow-lg transition-all duration-200 group">
                ...
                <div className="p-3">
                  ...
                  <div className="flex items-center mb-2">
                    <div className="flex">
                        {(() => {
                          const ratingVal = (typeof product.rating === 'number') ? product.rating : null;
                          const active = ratingVal ? Math.floor(ratingVal) : 0;
                      ...
                      {(typeof product.rating === 'number' || product.reviewCount != null) && (
